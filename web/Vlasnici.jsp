        ...
        <div class="DivGoreTabla1">
            ...
            <table id="zaglavlje1" class="zaglavlje">         
                <tr>
                  ...
                  <td width="400px" >Naziv Vlasnika</td>
                </tr> 
            </table>       
                ...
                <form action="PiBrIzServlet" method="post" style="display:inline">                      
                    <table id="podaci1" class="GornjaTabla" >                         
                        <%
                            ...
                            session.setAttribute("KoZove", "Vlasnik");
                            //Obavezno unositi bez blanka pre i posle zareza
                            String ImePolja = "NVlasnika";
                            ...
                            //myDataList = emp.ProcitajSvexx("Vlasnik", currUser.getVlasnik(),null);
                        ...
                        <tr> 
                            ...
                            <td width="50px"  class="maxText"><input id="SKonta" name="SVlasnika" placeholder="" class="S100Posto" type="text" value="<% out.println(sifra); %>"  disabled="disabled" maxlength="10"> </td>
                            <td width="400px" class="maxText"><input id="NKonta" name="NVlasnika" placeholder="" class="S100Posto" type="text" value="<% out.println(naziv); %>"  disabled="disabled" maxlength="45"> <% i++;}}catch(Exception e){}%></td>                        
