...
<html>
    ...
    <body class="LoginBody" onload="Timer()">        
        ...
        <div  class="DivGoreTabla1"> 
            ...
            <form action="AI6_IzvRazUCeniMem" method="post" style="text-align: center">
                <table class="izbor" style="margin-top:10px;">
                    <tr>
                      <th style="width:100%;">Pregled razlike u ceni (Memento):</th>
                    </tr>
                    <tr>
                        <td><input type="radio" name="VpMp" value="Vp" checked>Veleprodajne kalkulacije                       
                        <input type="radio" name="VpMp" value="Mp">Maloprodajne kalkulacije </td>                  
                    </tr>
                </table>                
                <input type="submit" class="dugmeOK" id="OK" name="OK" value="OK" style="visibility: visible; margin-top:10px;">            
            </form>            
            ...
            <div id="kojaKalk" style="margin-top:0px;" align="center">
                Pregled Razlike u Ceni za <% out.println(kojaKalk); %> Kalkulacije (Memento patern)
            </div>            
