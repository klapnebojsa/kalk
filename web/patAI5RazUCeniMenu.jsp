...
<html>
    <head>
        ...
        <title>Razlika u ceni (Bridge)</title>
    </head>
    <body class="LoginBody" onload="Timer()">        
        ...
        <div  class="DivGoreTabla1">
            ...
            <form action="AI5_IzvRazUCeni" method="post" style="text-align: center">
                <table class="izbor"  >
                    <tr>
                      <th>Pregled razlike u ceni (Bridge):</th>
                    </tr>                
                    <tr>
                ...
                <table class="izbor"  >
                    <tr>
                      <th>Format izveštaja:</th>
                    </tr>                
                    <tr>
                        <td><input type="radio" name="Izv" value="1" checked>Prvo Broj Kalkulacije</td>                     
                    </tr>
                    <tr>
                        <td><input type="radio" name="Izv" value="2">Prvo Datum </td>                  
                    </tr>
                </table> 
