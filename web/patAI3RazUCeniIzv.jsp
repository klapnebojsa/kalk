...
<%@page import="Povezivanje.ProcitajViseCellUslov"%>
...
<html>
    <head>
        ...
        <title>Razlika u ceni (Decorater)</title>
    </head>
    <body class="LoginBody" onload="Timer()">        
        ...
        <div  class="DivGoreTabla1">           
            <%
                ...
                ProcitajViseCellUslov emp = new ProcitajViseCellUslov();
                ...
                if ("mpkalkuk".equals(param[1])){
                    ...
                    k = mpkalkuk;
                    myDataList = emp.ViseUslov(k, param[0] + "," + param[2] + "," + param[3], "MpDatumUK ='" + param[5] + "'");                                 
                }
                if ("vpkalkuk".equals(param[1])){
                    Vpkalkuk vpkalkuk = new Vpkalkuk();                
                    vpkalkuk.setVpIdVlasnikUK(currUser.getVlasnik());   
                    k = vpkalkuk;
                    myDataList = emp.ViseUslov(k, param[0] + "," + param[2] + "," + param[3], "VpDatumUK ='" + param[5] + "'");                                 
                }                            
            ...
            <div id="kojaKalk" style="padding-top: 10px;" align="center">
                Pregled Razlike u Ceni za <% out.println(kojaKalk); %> Kalkulacije po datumu(Decorater patern)
            </div>            
