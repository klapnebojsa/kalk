...
<html>
    ...
    <body class="LoginBody" onload="Timer()">        
        ...
        <div  class="DivGoreTabla1">
            ...
            <form action="AI8_Servlet" method="post" style="text-align: center">
                <table class="izbor"  >
                    <tr>
                      <th>Uputstvo (Strategy):</th>
                    </tr>                
                    <tr>
                    ...
                    <tr>
                        <td><input type="radio" name="SrpskiKineski" value="Ar">Uputstvo - Arapski jezik </td>                  
                    </tr>                    
                    <tr>
                        <td><input type="radio" name="SrpskiKineski" value="Ji">Uputstvo - Jidiš </td>                  
                    </tr>                      
                </table>                
            ...
            <div id="porukaSer" style="margin-left: 100px;">           
                <c:if test="${not empty Poruka8}">
                    <p class="porukaBrisanja">${Poruka8}</p>
                </c:if>  
            </div>            
        </div>
