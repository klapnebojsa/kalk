    ...
    <body class="LoginBody" onload="Timer()">        
        ...
        <div class="DivGoreTabla1">
            ...
            <table id="zaglavlje1" class="zaglavlje">         
                <tr>
                  <td width="10px"></td>                 
                  <td width="150px">Šifra/Korisničko ime</td> 
                  <td width="100px" >Password</td>
                  <td width="150px" >Vlasnik</td>
                  <td width="200px">Prezime</td> 
                  <td width="200px" >Ime</td>
                  <td width="50px" >Nivo</td>                  
                ...
                <form action="PiBrIzServlet" method="post" style="display:inline">                      
                    <table id="podaci1" class="GornjaTabla" >                         
                        <%
                            ...
                            session.setAttribute("KoZove", "Korisnik");
                            //Obavezno unositi bez blanka pre i posle zareza
                            String ImePolja = "PassKor,VlaKor,PreKor,ImeKor,NivoKor";
                            session.setAttribute("ImePolja", ImePolja);
                            
                            String sifra, password, vlasnik, prezime, ime, nivo;    
                            ...
                            try{
                                ...
                                if (jesteNovi == "novi"){
                                    ...
                                    for (int i = 1; i <= 7; i++) {singleRow.add("");}
                                    myDataList.add(singleRow);                                    
                                    //Obavezno unositi bez blanka pre i posle zareza
                                    ImePolja = "SifKor,PassKor,VlaKor,PreKor,ImeKor,NivoKor";
                            ...
                            k = vVlasnik;
                            List myVlasnikCBox = emp.ProcitajSvexx(k);                            
                            ...
                            try{
                                for(Object category : myDataList) {
                                    ...
                                    password=element.get(1).toString();
                                    vlasnik=element.get(2).toString();
                                    prezime=element.get(3).toString();
                                    ime=element.get(4).toString();
                                    nivo=element.get(5).toString();

                        %> 

                        <tr>
                            <td width="5px"   class="radioTD"><input type="radio" class="radio1" value="<%=sifra %>" name="oznXX" onclick="check('<%=ImePolja %>')" /></td>                   
                            <td width="150px" class="maxText"><input id="SifKor"  name="SifKor" placeholder="" class="S100Posto" type="text" value="<% out.println(sifra); %>"  disabled="disabled" maxlength="20"> </td>
                            <td width="100px" class="maxText"><input id="PassKor" name="PassKor" placeholder="" class="S100Posto" type="text" value="<% out.println(password); %>"  disabled="disabled" maxlength="20"> </td>

                            <td width="150px" class="maxText">
                                <select id="VlaKor"  name="VlaKor" placeholder="" class="S100Posto" type="text" value="<% out.println(vlasnik); %>" disabled="disabled">
                                    <%
                                        String elemVCB, kkgg;
                                        kkgg = "";
                                        for(Object vlas : myVlasnikCBox) {
                                            List elem = (List)vlas;
                                            elemVCB = elem.get(0).toString() + " - " + elem.get(1).toString();
                                            kkgg = "";
                                            if (vlasnik.equals(elem.get(0).toString()))kkgg = "SELECTED";
                                    %>    
                                    <option <% out.println(kkgg); %> ><% out.println(elemVCB); %></option>    
                                    <% } %>
                                </select>
                            </td>                            
                            <td width="200px" class="maxText"><input id="PreKor"  name="PreKor" placeholder="" class="S100Posto" type="text" value="<% out.println(prezime); %>"  disabled="disabled" maxlength="20"> </td>
                            <td width="200px" class="maxText"><input id="ImeKor"  name="ImeKor" placeholder="" class="S100Posto" type="text" value="<% out.println(ime); %>"  disabled="disabled" maxlength="20"> </td>                           
                            <td width="50px"  class="maxText"><input id="NivoKor" name="NivoKor" placeholder="" class="S100Posto" type="text" value="<% out.println(nivo); %>"  disabled="disabled" maxlength="2"> <% i++;}}catch(Exception e){}%></td>                        
