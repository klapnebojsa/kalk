...
<html>
    ...
    <body class="LoginBody" onload="Timer()">        
        ...
        <div  class="DivGoreTabla1">
            ...
            <form action="AI3_IzvRazUCeni" method="post" style="text-align: center">
                <table class="izbor"  >
                    <tr>
                      <th>Pregled razlike u ceni (Decorater):</th>
                    </tr>                
                    <tr>
                ...
                <table class="izbor"  >
                    ...
                    <tr>
                        <td width="80px"  class="maxText"><input id="MDatu" name="MDatu" class="S100Posto" type="date" value="2015-01-01" style="text-align: center"> </td>                    
                    </tr>
                </table>                 
