    ...
    <body class="LoginBody" onload="Timer()">        
        ...
        <div  class="DivGoreTabla1">           
            <%
                ...
                String formatX = param[5];
            %>
            
            <div id="kojaKalk" style="padding-top: 10px;" align="center">
                Pregled Razlike u Ceni za <% out.println(kojaKalk); %> Kalkulacije (Bridge patern  <% out.println(formatX); %>)
                <p><% out.println(dodatOipis); %></p>       
            </div>            
                    ...
                    <%
                        ...
                        try{
                            for(Object category : myDataList) {
                                ...
                                datum=sdf.parse(element.get(2).toString());
                                date = sdf.format(datum);
                                razuCeni=element.get(1).toString();                                    
                    %>               
                    <tr> 
