<%-- 
    Document   : VpKalkStavka
    Created on : Mar 10, 2015, 3:26:07 PM
    Author     : neso
--%>

<%@page import="KlaseBaze.Artikal"%>
<%@page import="KlaseBaze.Vpkalkstavka"%>
...
<!DOCTYPE html>
    <head>
        ...
        <title>Stavke VP Kalkulacije</title>
    </head>
    ...
    <body class="LoginBody" onload="Timer()">        
        ...
        <div class="DivGoreTabla1">
            <div>
                <table  id="naslov">                  
                    <td>VP Kalkulacija:  <%=session.getAttribute("BrDok").toString()%>
                </table>
            </div>               
            ...
            <table id="zaglavlje1" class="zaglavlje"   style="width:1080px;">         
                <tr>
                  ...
                  <td width="100px">VP Cena</td>                  
                  <td width="120px">Nab.Cena UK</td> 
                  <td width="120px">VP Cena UK</td> 
                ...
                <form action="PiBrIzServlet" method="post" style="display:inline">                      
                    <table id="podaci1" class="GornjaTabla"  style="width:1080px;">                         
                        <%
                            ...
                            session.setAttribute("KoZove", "VpKalkStavka");
                            //Obavezno unositi bez blanka pre i posle zareza
                            String ImePolja = "VIdAr,VKoli,VNCen,VVCen"; // ,VNCeS,VVCeS,VRCeS,VVPoS";
                            session.setAttribute("ImePolja", ImePolja);
                            
                            String sifra,artik,kolic,nabav,velep,nabce,vpcen,razli,porez;
                            ProcitajSve emp = new ProcitajSve();
                            List myDataList = null;
                                                 
                            Vpkalkstavka vpkalkstavka = new Vpkalkstavka();
                            vpkalkstavka.setVpIdVlasnik(currUser.getVlasnik());
                            vpkalkstavka.setVpIdKalk(BrDok);
                            InterfaceDAO v = vpkalkstavka;
                            ...
                            try{
                                ...
                                if (jesteNovi == "novi"){
                                    ...
                                    //Obavezno unositi bez blanka pre i posle zareza
                                    ImePolja = "VIdAr,VKoli,VNCen,VVCen"; // ,VNCeS,VVCeS,VRCeS,VVPoS";
                            ...
                            try{
                                for(Object category : myDataList) {
                                    ...
                                    velep=element.get(6)==null? "" : element.get(6).toString();                                    
                                    DecimalFormat df = new DecimalFormat("##,##0.00");
                                    nabce=(element.get(7)==null  || element.get(7)=="")? ""  : df.format(element.get(7));                                
                                    vpcen=(element.get(8)==null  || element.get(8)=="")? ""  : df.format(element.get(8));
                        ...
                        <tr> 
                            ...
                            <td width="300px" class="maxText">
                                <select id="VIdAr"  name="VIdAr" class="S100Posto"  disabled="disabled">
                                    <%
                                        String elemNP, kkpp;
                                        kkpp = "";
                            ...
                            <td width="100px" class="maxText"><input id="VKoli" name="VKoli" placeholder="" class="S100Posto" type="text" value="<% out.println(kolic); %>" disabled="disabled" maxlength="12" style="text-align: right"> </td>                              
                            <td width="100px" class="maxText"><input id="VNCen" name="VNCen" placeholder="" class="S100Posto" type="text" value="<% out.println(nabav); %>" disabled="disabled" maxlength="12" style="text-align: right"> </td>                              
                            <td width="100px" class="maxText"><input id="VVCen" name="VVCen" placeholder="" class="S100Posto" type="text" value="<% out.println(velep); %>" disabled="disabled" maxlength="12" style="text-align: right"> </td>                                  
                            
                            <td width="150px" class="maxText"><input id="VNCeS" name="VNCeS" placeholder="" class="S100Posto" type="text" value="<% out.println(nabce); %>" readonly="readonly" maxlength="12" style="text-align: right"> </td>
                            <td width="150px" class="maxText"><input id="VVCeS" name="VVCeS" placeholder="" class="S100Posto" type="text" value="<% out.println(vpcen); %>" readonly="readonly" maxlength="12" style="text-align: right"> </td>                            
                            <td width="150px" class="maxText"><input id="VRCeS" name="VRCeS" placeholder="" class="S100Posto" type="text" value="<% out.println(razli); %>" readonly="readonly" maxlength="12" style="text-align: right"> </td>                            
                            <td width="150px" class="maxText"><input id="VVPoS" name="VVPoS" placeholder="" class="S100Posto" type="text" value="<% out.println(porez); %>" readonly="readonly" maxlength="12" style="text-align: right"> <% i++;}}catch(Exception e){}%></td>               
                        </tr>
                    </table>                    
