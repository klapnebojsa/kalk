                ...
                <form action="PiBrIzServlet" method="post" style="display:inline">                      
                    <table id="podaci1" class="GornjaTabla" >                         
                        <%
                            ...
                            session.setAttribute("KoZove", "Porez");
                            //Obavezno unositi bez blanka pre i posle zareza
                            String ImePolja = "PPoreza,NPoreza";
                            session.setAttribute("ImePolja", ImePolja);
                            
                            String sifra, procenat, naziv;    
                            ...
                            //myDataList = emp.ProcitajSvexx("Porez", currUser.getVlasnik(),null);
                            ...
                            try{
                                ...
                                if (jesteNovi == "novi"){
                                    ...
                                    for (int i = 1; i <= 4; i++) {singleRow.add("");}
                                    myDataList.add(singleRow);                                    
                                    //Obavezno unositi bez blanka pre i posle zareza
                                    ImePolja = "SPoreza,PPoreza,NPoreza";
                            ...
                            try{
                                for(Object category : myDataList) {
                                    ...
                                    procenat=element.get(1).toString();
                        ...
                        <tr> 
                            ...
                            <td width="50px"  class="maxText"><input id="SPoreza" name="SPoreza" placeholder="" class="S100Posto" type="text" value="<% out.println(sifra); %>"  disabled="disabled" maxlength="4"> </td>
                            <td width="100px" class="maxText"><input id="PPoreza" name="PPoreza" placeholder="" class="S100Posto" type="text" value="<% out.println(procenat); %>"  disabled="disabled" maxlength="7"> </td>                            
                            <td width="400px" class="maxText"><input id="NPoreza" name="NPoreza" placeholder="" class="S100Posto" type="text" value="<% out.println(naziv); %>"  disabled="disabled"  maxlength="20"> <% i++;}}catch(Exception e){}%></td>                        
